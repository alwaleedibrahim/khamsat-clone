...
const SearchForm: React.FC<ISearchForm> = ({
    ...
    return (
        <form action={action} method="get" className="flex w-[100%] items-center relative">
            <input
                name="q"
                className="h-[70px] pl-[18%] mb-0 w-full text-md text-black px-3 py-1.5 bg-white border border-gray-300 rounded-none block text-gray-800 focus:outline-none focus:border-primary transition-colors"
